      ...
      <div class="flex items-center justify-end space-x-4">
        ...
        <div class="relative">
          ...
          <MenuList v-if="isAddMenuOpen" title="Create">
            ...
            <div class="mx-2 my-2 border-b border-gray-400"></div>
            <MenuListItem title="Advertisment" subtitle="Easy advertising for your company">
        ...
        <button
          type="button"
          class="bg-gray-300 rounded-full p-2 hover:bg-gray-400 focus:bg-blue-100 focus:text-blue-700"
        >
